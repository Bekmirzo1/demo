...
if (e.target.closest('a')) {
    if (e.target.href != '') {
        wrapper.classList.add('_another');
    }
}
}); */
if (wrapper) {
    if (!document.querySelector('.content-preload')) {
        wrapper.insertAdjacentHTML('beforebegin',
            // `
            // <div class="wrapper__preload">
            //     <div class="wrapper__preload-svg">
            //         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 137.04 98.87">
            //             <defs>
            //                 <style>
            //                     .cls-1 {
            //                         fill: none;
            ...
            //                     <path class="cls-1"
            //                         d="M104.48,49.9c9.32,3,19.33,8,30.09,15.54,0,0-23.35,19.38-53.51,19.38-13.65,0-23.86-.4-46.85-8.1,0,0-11.56,4.36-32.71,19.26V71L11,65.43,1.5,59.72V35.07C24,50.11,34.19,54.15,34.19,54.15a97.21,97.21,0,0,1,15.23-4.8L43.26,24.91l13.85,7.22,2.7-13.22L69.26,27,77.37,4.42,85.56,27l9.81-7.73L98,32.13l13.62-7.22Z" />
            //                 </g>
            //             </g>
            //         </svg>
            //     </div>
            ...
            /*  `
             <div class="content-preload">
                 <div class="content-preload__svg">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 137.04 98.87">
                         <g data-name="Layer 2">
                             <path d="M104.48 49.9c9.32 3 19.33 8 30.09 15.54 0 0-23.35 19.38-53.51 19.38-13.65 0-23.86-.4-46.85-8.1 0 0-11.56 4.36-32.71 19.26V71l9.5-5.57-9.5-5.71V35.07C24 50.11 34.19 54.15 34.19 54.15a97.21 97.21 0 0 1 15.23-4.8l-6.16-24.44 13.85 7.22 2.7-13.22L69.26 27l8.11-22.58L85.56 27l9.81-7.73L98 32.13l13.62-7.22Z" fill="none" stroke="#2d4086" stroke-miterlimit="10" stroke-width="3" data-name="Layer 1"/>
                         </g>
                     </svg>
                 </div>
             </div>
        ...
        <div class="content-preload">
            <div class="content-preload__svg">
                <svg viewBox="0 0 138 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M104.98 50.48C114.3 53.48 124.31 58.48 135.07 66.02C135.07 66.02 111.72 85.4 81.56 85.4C67.91 85.4 57.7 85 34.71 77.3C34.71 77.3 23.15 81.66 2 96.56V71.58L11.5 66.01L2 60.3V35.65C24.5 50.69 34.69 54.73 34.69 54.73C39.6264 52.715 44.7203 51.1096 49.92 49.93L43.76 25.49L57.61 32.71L60.31 19.49L69.76 27.58L77.87 5L86.06 27.58L95.87 19.85L98.5 32.71L112.12 25.49L104.98 50.48Z" stroke="url(#paint0_linear_1602_6848)" stroke-width="3" stroke-miterlimit="10"/>
                    <defs>
                        ...
                        <stop offset="0.484375" stop-color="#9FACDB"/>
                        <stop offset="0.65625" stop-color="#2D4086"/>
    ...
    <div class="wrapper__preload">
        ...
        <path class="line-map" d="M729.114 83.9394C720.546 107.321 740.614 115.526 756.675 130.807C761.434 135.336 761.888 142.817 756.879 147.342C746.107 157.074 705.264 142.917 707.854 155.745C710.53 168.994 745.061 187.531 746.618 188.799C760.284 199.932 764.735 228.174 757.208 243.658C751.852 254.676 716.342 250.962 705.172 247.293C632.024 223.266 664.985 226.131 582.817 218.67C576.527 218.099 569.935 217.806 563.894 219.65C557.671 221.549 557.869 229.339 559.957 233.55C566.876 247.506 597.849 271.178 589.514 289.523C586.956 295.152 580.963 298.707 578.264 304.27C576.151 308.627 576.385 313.772 575.445 318.523" stroke="white" stroke-width="2"></path>
        <path class="circle-5" fill-rule="evenodd" clip-rule="evenodd" d="M573.5 326C577.09 326 580 323.09 580 319.5C580 315.91 577.09 313 573.5 313C569.91 313 567 315.91 567 319.5C567 323.09 569.91 326 573.5 326Z" fill="#4AF6CD"></path>
        <path class="circle-2" fill-rule="evenodd" clip-rule="evenodd" d="M661 363C662.657 363 664 361.657 664 360C664 358.343 662.657 357 661 357C659.343 357 658 358.343 658 360C658 361.657 659.343 363 661 363Z" fill="#4AF6CD"></path>
        <path class="circle-3" fill-rule="evenodd" clip-rule="evenodd" d="M725 471C726.657 471 728 469.657 728 468C728 466.343 726.657 465 725 465C723.343 465 722 466.343 722 468C722 469.657 723.343 471 725 471Z" fill="#4AF6CD"></path>
        <path class="circle-1" fill-rule="evenodd" clip-rule="evenodd" d="M365 228C366.657 228 368 226.657 368 225C368 223.343 366.657 222 365 222C363.343 222 362 223.343 362 225C362 226.657 363.343 228 365 228Z" fill="#4AF6CD"></path>
        <path class="circle-4" fill-rule="evenodd" clip-rule="evenodd" d="M729.5 91C733.09 91 736 88.0899 736 84.5C736 80.9101 733.09 78 729.5 78C725.91 78 723 80.9101 723 84.5C723 88.0899 725.91 91 729.5 91Z" fill="#4AF6CD"></path>
    ...
    `) */
    const preload = document.querySelector('.content-preload');
    if (preload) {
        if (!preload.classList.contains('_loaded')) {
            preload.classList.add('_unload')
            window.addEventListener("load", function () {
                setTimeout(function () {
                    preload.classList.remove('_unload');
	...
	if (inputs.length > 0) {
		for (let index = 0; index < inputs.length; index++) {
			...
			if (input.classList.contains('_date')) {
				...
				// Calendar icon
				if (input.closest('.book__calendar')) {
					const bookCalendar = document.querySelector('.book__calendar');
					if (bookCalendar) {
						const calendar = bookCalendar.querySelector('.qs-datepicker-container');
						const bookIcon = document.querySelector('.book__calendar-icon');
						bookIcon.addEventListener('click', function (e) {
							e.stopPropagation();
							// if (bookCalendar.classList.contains('_focus')) {
							// 	calendarItem.hide();
							// 	input_focus_remove(input);
							// } else if (!bookCalendar.classList.contains('_focus')) {
							// 	calendarItem.show();
							// 	input_focus_add(input);
							// }
							const isHidden = calendarItem.calendarContainer.classList.contains('qs-hidden')
							calendarItem[isHidden ? 'show' : 'hide']()
							// e.preventDefault();
						});
					}
				}
...
if (menuItems.length > 0) {
    if (isMobile.any()) {
        document.addEventListener('click', function (e) {
            ...
            if (subItemActive) {
                if (!e.target.classList.contains('._item._change') && !e.target.closest('._item._change')) {
        ...
        for (let index = 0; index < menuItems.length; index++) {
            ...
            const menuLink = menuItem.querySelector('._item__link');
            menuLink.addEventListener('click', function (e) {
                const changed = document.querySelector('._item._change');
                if (!e.target.closest('._item').classList.contains('_change')) {
                    if (changed) {
                        changed.classList.remove('_change');
                    }
                    e.target.closest('._item').classList.add('_change');
                } else {
                    e.target.closest('._item').classList.remove('_change')
                }
                // e.preventDefault();
            });
        }
...
if (mr) {
    const mrPagination = document.querySelector('.mr__pagination');
    const mrPaginationLastItem = mrPagination.querySelector('.pag-top__list-last');
    const mrPaginationLastItemLink = mrPaginationLastItem.querySelector('a');
    const mrList = document.querySelector('.mr__list');
    const mrItems = mrList.querySelectorAll('.mr__item');
    if (mrItems.length > 0) {
        for (let index = 0; index < mrItems.length; index++) {
            const mrItem = mrItems[index];
            mrItem.addEventListener('click', function () {
                if (!mrItem.classList.contains('_active')) {
                    mrPaginationLastItemLink.textContent = mrItem.textContent;
                }
            });
        }
    }
...
const videoDelivery = document.querySelector('.choice-deliver__column_video');
if (videoDelivery) {
    const video = videoDelivery.querySelector('video');
    document.addEventListener('mouseover', function (e) {
        // video.play();
        if (e.target.closest('.choice-deliver__column_video')) {
            video.play();
        } else {
            video.pause();
            video.currentTime = 0;
    ...
    // videoDelivery.addEventListener('mouseout', function () {
    //     video.pause();
    //     video.currentTime = 0;
    // });
}

const popupPanoramas = document.querySelector('.panoramas-popup');
if (popupPanoramas) {
    function panoramaPopups(media) {
        if (!media.mathes) {
            if (popupPanoramas.classList.contains('_active')) {
                popup_close(popupPanoramas)
            }
        }
    }
    const panoramaMedia = window.matchMedia('(max-width: 479.98px)');
    panoramaMedia.addListener(panoramaPopups);
    panoramaPopups(panoramaMedia);
}
...
/* if (textareaDynamic) {
    ...
    function textareaHeight() {
        ...
        const textareafullHeight = textarea.scrollHeight;
        round = Math.round(parseInt(textareafullHeight) / parseFloat(textareaLineHeight));
        if (textarea.value == "") {
            textarea.style.height = textareaLineHeight;
            textarea.style.overflow = 'hidden';
        } else if (1 < round && round < 6) {
            // textarea.style.height = textareafullHeight + 'px';
            // console.log(round);
            console.log(parseFloat(textareaLineHeight) * round);
            const number = parseFloat(textareaLineHeight) * round;
            textarea.style.height = number + 'px';
        } else if (round > 5) {
...
const textareaDynamic = document.querySelector('._textarea-dynamic');
if (textareaDynamic) {
    const textarea = textareaDynamic.querySelector('textarea');
...
function initMap() {
    ...
    const place2 = { lat: 55.74826229920637, lng: 37.58215725123303 };
    const place = { lat: 55.7406139823734, lng: 37.640771476191986 };
    const myMap = new google.maps.Map(document.getElementById("map"), {
        zoom: 13,
        center: place,
        // content: '<div id="foo">Bar</div>',
        // отключает настройки управления по умолчанию
        disableDefaultUI: true,
    });
    // Вставка стилей карт в нынешние карты
    myMap.mapTypes.set("styled_map", styledMapType);
    myMap.setMapTypeId("styled_map");

    const adressText = 'Москва, ул. Садовническая 57с1';
    const adressText2 = 'Москва, Смоленская площадь 7-9';
    let image = 'img/contact/blue.svg';
    let image2 = 'img/contact/black.svg';
    ...
    marker2Active = new google.maps.Marker({
        position: place2,
        map: myMap,
        icon: image,
        // icon: svgMarker,
    ...
    const popupContent = `<div class="map-popup-text">${adressText}</div>`;
    const popupContent2 = `<div class="map-popup-text">${adressText2}</div>`;
    ...
    infowindow.open(myMap, markerActive);
    setMapOne(null, marker);
    setMapOne(null, marker2Active);
    marker.addListener('click', function () {
        // marker = null;
        setMapOne(myMap, markerActive);
        setMapOne(null, marker);
        setMapOne(myMap, marker2);
        setMapOne(null, marker2Active);
        infowindow.open(myMap, markerActive);
    });
    marker2.addListener('click', function () {
        // marker = null;
        setMapOne(null, markerActive);
        setMapOne(myMap, marker);
        setMapOne(null, marker2);
        setMapOne(myMap, marker2Active);
        infowindow2.open(myMap, marker2Active);
    });
    markerActive.addListener('click', function () {
        infowindow.open(myMap, markerActive);
    });
    marker2Active.addListener('click', function () {
        infowindow.open(myMap, marker2Active);
    });
}

function setMapOne(map, mark) {
    mark.setMap(map);
}

// *Content map height
const contentMap = document.querySelector('.contacts__map');
if (contentMap) {
    window.addEventListener('resize', heightMap);
    function heightMap() {
        const mapBody = contentMap.querySelector('.contacts__map-body');
        const contactContent = document.querySelector('.contacts__content');
        if (window.innerWidth > 1023.98) {
            contentMap.style.height = contactContent.offsetHeight + 'px';
        } else {
            contentMap.style.height = mapBody.offsetHeight + 'px';
        }
    }
    heightMap();
}
...
if (select) {
    if (select.firstElementChild.tagName !== 'SELECT') {
        select.firstElementChild.remove();
        if (select.querySelector('.select')) {
            // const select2 = select.querySelector('.select');
            select.removeAttribute('class')
            // select.classList.remove('select')
            // select.classList.remove('select_sel')
            // select.insertAdjacentHTML('beforebegin', select.cloneNode(true))
            // select.remove();
        }
    }
}
...
if (document.querySelector('.full')) {
    ...
    let fullSlider = new Swiper('.full', {
        wrapperClass: 'full__wrapper',
        slideClass: 'full__screen',
        simulateTouch: false,
        direction: 'vertical',
        slidesPerView: 'auto',
        parallax: true,
        ...
        pagination: {
            ...
            type: 'bullets',
            clickable: 'true',
            bulletClass: 'full__bullet',
            bulletActiveClass: 'full__bullet_active'
        },
        // Скролл
        scrollbar: {
            el: '.full-scroll',
            dragClass: 'full-scroll__drag',
    ...
    function whiteBlue() {
        ...
        const pagination = document.querySelector('.full__pagination');
        pagination.classList.remove('_white')
        if (slideActive.classList.contains('_white')) {
            pagination.classList.add('_white')
        } else {
            pagination.classList.remove('_white')
        }
    }
    ...
    function setScrollType() {
        if (wrapper.classList.contains('_free')) {
            ...
            fullSlider.params.freeMode = false;
            // fullSlider.params.parallax = true;
        }
        for (let index = 0; index < fullSlider.slides.length; index++) {
            const pageSlide = fullSlider.slides[index];
            const pageSlideContent = pageSlide.querySelector('.screen__content');
            // if (pageSlideContent && window.innerWidth > 767.98) {
            if (pageSlideContent) {
                const pageSlideContentHeight = pageSlideContent.offsetHeight;
                const header = document.querySelector('.header');
                if (pageSlideContentHeight > window.innerHeight - header.offsetHeight) {
                    wrapper.classList.add('_free');
                    fullSlider.params.freeMode = true;
                    // fullSlider.params.parallax = true;
                    break;
                }
            }
    ...
    if (headerLogo) {
        headerLogo.addEventListener('click', function (e) {
            fullSlider.slideTo(0, 1000)
            e.preventDefault();
        });
    }
    function deleteParallax() {
        /*         function delByAttributes(setParallax) {
                    const parallaxImages = document.querySelectorAll(`[${setParallax}]`);
                    let valueAttribute;
                    parallaxImages.forEach(element => {
                        if (window.innerWidth < 767.98) {
                            valueAttribute = element.getAttribute(setParallax);
                            // console.log(valueAttribute);
                            element.classList.add(`_pr-${setParallax}`)
                            element.removeAttribute(`${setParallax}`)
                        } else if ((window.innerWidth > 767.98)) {
                            console.log(valueAttribute);
                            const prReverse = document.querySelector(`._pr-data-swiper-parallax-x`);
                            if (prReverse) {
                            // if (element.classList.contains(`about-screen__container`)) {
                                // element.setAttribute(attribute, '10');
                                console.log('1');
                                // element.classList.remove(`_pr-${attribute}`);
                            }
                        }
                    });
        
                } */
        function delByAttributes(setParallax, tag = '') {
            const parallaxImages = document.querySelectorAll(`${tag}[${setParallax}]`);
            parallaxImages.forEach(element => {
                if (window.innerWidth < 767.98) {
                    element.removeAttribute(`${setParallax}`)
        ...
        delByAttributes('data-swiper-parallax-y');
        delByAttributes('data-swiper-parallax-x');
        delByAttributes('data-swiper-parallax-opacity', '.about-screen__container');
        // const containerOpacity = document.querySelectorAll('.about-screen__container');

        // delByAttributes('data-swiper-parallax-opacity');
        // delByAttributes('data-swiper-parallax-scale');
        /* const ssss = document.querySelectorAll(`[data-swiper-parallax-y]`);
        if (window.innerWidth < 767.98) {
            ssss.forEach(element => {
                element.removeAttribute('data-swiper-parallax-y')
            });
        } */

        /* const ssss2 = document.querySelectorAll(`[data-swiper-parallax-x]`);
        if (window.innerWidth < 767.98) {
            ssss2.forEach(element => {
                element.removeAttribute('data-swiper-parallax-x')
            });
        } */
    }
    // Включение инициацизвции для корректной работы
    fullSlider.init();
}


// recipes
if (document.querySelector('.recipes-chef__columns')) {
    const recipeSlider = document.querySelector('.recipes-chef__columns');
    let swiperRecipe;
    function swiperAdapt(media) {
        if (media.matches) {
            recipeSlider.classList.add('_swiper')
            swiperRecipe = new Swiper('.recipes-chef__columns', {
                /*
                effect: 'fade',
                fadeEffect: {
                    crossFade: true
                ...
                */
                ...
                // Arrows
                navigation: {
                    nextEl: '.recipes-chef__nav .nav-elem__arrow_right',
                    prevEl: '.recipes-chef__nav .nav-elem__arrow_left',
                },
                breakpoints: {
                    // 320: {
                    //     slidesPerView: 1,
            ...
            if (recipeSlider.classList.contains('swiper-container-initialized')) {
                swiperRecipe.destroy();
            }
            recipeSlider.classList.remove('_swiper')
        }
    }
    const siperMedia = window.matchMedia('(min-width: 767.98px)');
    siperMedia.addListener(swiperAdapt);
    swiperAdapt(siperMedia);
}
...
if (panoramas) {
    let panoramasSlider;
    let panoramasImages;
    if (document.querySelector('.panoramas__slider')) {
        panoramasSlider = new Swiper('.panoramas__slider', {
            /*
            effect: 'fade',
            fadeEffect: {
                crossFade: true
            ...
            */
            ...
            // Dotts
            pagination: {
                el: '.nav-elem .nav-elem__fraction',
                // clickable: true,
                type: 'fraction',
                currentClass: 'nav-elem__current',
                totalClass: 'nav-elem__total',
                renderFraction: function (currentClass, totalClass) {
                    return `
                <span class="${currentClass}">1</span>
                <span class="nav-elem__slash">/</span>
                <span class="${totalClass}">10</span>
                `
                }
            },
            // Arrows
            navigation: {
                nextEl: '.nav-elem .nav-elem__arrow_right',
                prevEl: '.nav-elem .nav-elem__arrow_left',
            },
            breakpoints: {
                320: {
                    spaceBetween: 10,
    ...
    if (document.querySelector('.images-panoramas__body')) {
        panoramasImages = new Swiper('.images-panoramas__body', {
            /*
            effect: 'fade',
            fadeEffect: {
                crossFade: true
            ...
            */
            ...
            // Dotts
            // pagination: {
            //     el: '.images-panoramas__body .nav-elem__fraction',
            //     // clickable: true,
            //     type: 'fraction',
            //     currentClass: 'nav-elem__current',
            //     totalClass: 'nav-elem__total',
            ...
            // // Arrows
            // navigation: {
            //     nextEl: '.images-panoramas__body .nav-elem__arrow_right',
            //     prevEl: '.images-panoramas__body .nav-elem__arrow_left',
            // },
            /*
            breakpoints: {
                320: {
    ...
    panoramasSlider.controller.control = panoramasImages;
    panoramasImages.controller.control = panoramasSlider;
}

// Images Slider
if (document.querySelector('.slider-images__body')) {
    let sliderImages = new Swiper('.slider-images__body', {
        ...
        */
        ...
        // Dotts
        pagination: {
            el: '.slider-images__body .nav-elem__fraction',
            // clickable: true,
            type: 'fraction',
            currentClass: 'nav-elem__current',
            totalClass: 'nav-elem__total',
        ...
        // Arrows
        navigation: {
            nextEl: '.slider-images__body .nav-elem__arrow_right',
            prevEl: '.slider-images__body .nav-elem__arrow_left',
        },
    ...
    function centeredSlide(media) {
        // if (!media) {
        //     sliderImages.params.centeredSlides = false;
        // } else {
        //     sliderImages.params.centeredSlides = true;
        // }
        if (window.innerWidth > 767.98) {
            sliderImages.params.centeredSlides = true;
        } else {
    ...
    sliderImages.init();
    // const centerMedia = window.matchMedia('(max-width: 767.98px)');
    // centerMedia.addListener(centeredSlide);
    // centeredSlide(centerMedia);
}
...
if (scr_fix_block.length > 0) {
	...
	function fix_block(scr_fix_block) {
		...
		let footer_height = 0;
		if (!_is_hidden(footer)) {
			footer_height = parseInt(footer.offsetHeight);
		}
		// let header_height = 15;
		const heightItem = "height:" + (window.innerHeight - header_height - footer_height) + "px";
		for (let index = 0; index < scr_fix_block.length; index++) {
			...
			// if (item.offsetHeight < window_height - (header_height)) {
			if (scr_value > offset(block).top - (header_height)) {
				item.style.cssText = "position:fixed;bottom:auto;top:" + header_height + "px;width:" + block.offsetWidth + "px;left:" + offset(block).left + "px;" + heightItem;
			} else {
				gotoRelative(item);
			}
		...
		function gotoRelative(item) {
			item.style.cssText = "position:relative;bottom:auto;top:0px;left:0px;" + heightItem;
		}
	}
	fix_block(scr_fix_block);
}
...
// Перенос контентов из панорам в слайды с картинками и обратно
const panoramasContents = document.querySelectorAll('.panoramas__content');
if (panoramasContents.length > 0) {
	const parent_original = document.querySelectorAll('.panoramas__slide');
	const parent = document.querySelectorAll('.images-panoramas__slide');
	for (let index = 0; index < panoramasContents.length; index++) {
		const item = panoramasContents[index];
		function dinamicAdaptive(e) {
			if (e.matches) {
				if (!item.classList.contains('done')) {
					parent[index].insertBefore(item, parent[index].children[1])
					item.classList.add('done')
				}
			} else {
				if (item.classList.contains('done')) {
					parent_original[index].insertBefore(item, parent_original[index].children[1])
					item.classList.remove('done')
				}
			}
		}
...
/* var options = {
    ...
    linkSelector: 'a[href^="' + window.location.origin + 'dsladopasko' + '"]:not([data-no-swup]), a[href^="/"]:not([data-no-swup])',
...
// if (pathNameArray.length > 1 && pathNameArray[(pathNameArray.length - 1)].includes('.html')) {
swup.on('contentReplaced', scriptLoad);
...
function linkSwupChange() {
    const pathname = window.location.pathname;
    const pathNameArray = pathname.split('/');
    let pathBefore;
    if (pathNameArray.length > 1) {
        console.log(pathNameArray);
        // const last = pathNameArray[(pathNameArray.length - 1)];
        pathNameArray.pop();
        pathBefore = pathNameArray.join('/');
        console.log(pathBefore);
        const ahrefs = document.querySelectorAll('a');
        if (ahrefs.length > 0) {
            for (let index = 0; index < ahrefs.length; index++) {
                const ahref = ahrefs[index];
                // console.log(ahref.getAttribute('href')[0]);
                if (ahref.getAttribute('href')[0] == '/' && ahref.getAttribute('href')[1]) {
                    // ahref.setAttribute('data-swap', `${pathBefore}`)
                    // console.log(ahref.getAttribute('href'));
                    ahref.setAttribute('href', `${pathBefore}L${ahref.getAttribute('href')} `)
                }
            }
        }
    }
...
linkSwupChange();
swup.on('animationInDone', linkSwupChange);
