...
let pathBefore;
if (pathNameArray.length > 2 && pathNameArray[(pathNameArray.length - 1)].includes('.html')) {
...
if (ahrefs.length > 0) {
    for (let index = 0; index < ahrefs.length; index++) {
        ...
        if (ahref.getAttribute('href')[0] == '/' && ahref.getAttribute('href')[1]) {
            ...
            ahref.setAttribute('href', `${ahref.dataset.swap}${ahref.getAttribute('href')} `)
        }
    }
}
